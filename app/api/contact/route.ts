...
const CONTACT_TO = process.env.CONTACT_EMAIL_TO ?? "organizers@example.com";
const CONTACT_CC = process.env.CONTACT_EMAIL_CC;
        ...
        await sendEmail({
          ...
          <body style="background:#131313;color:#e5e2e1;font-family:'JetBrains Mono',monospace;padding:40px;">
            <div style="max-width:620px;margin:0 auto;border-left:4px solid #39FF14;padding-left:24px;">
              ...
              <h2 style="font-size:24px;margin-bottom:16px;">New contact portal message</h2>
              ...
              <div style="margin-top:24px;">
                <a href="${APP_URL}/organizer/contacts?message=${contact.id}"
